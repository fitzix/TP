...
-- ----------------------------
 DROP TABLE IF EXISTS `zl_auth_rule`;
CREATE TABLE `zl_auth_rule` (  
...
-- ----------------------------
 DROP TABLE IF EXISTS `zl_auth_group`;
CREATE TABLE `zl_auth_group` ( 
    `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT, 
...
-- ----------------------------
DROP TABLE IF EXISTS `zl_auth_group_access`;
CREATE TABLE `zl_auth_group_access` (  
