...
$(function () {
    //SKU信息
    $("#goodsattrvaluse label").bind("change", function () {
        step.Creat_Table();
    });
    var step = {
        //SKU信息组合
        Creat_Table: function () {
            ...
            if (bCheck == true) {
                var RowsCount = 0;
                $("#createTable").html("");
                var table = $("<table id=\"process\" class=\"table table-striped table-bordered table-hover\"></table>");
                ...
                if (zuheDate.length > 0) {
                    ...
                    $.each(zuheDate, function (index, item) {
                        ...
                        $.each(td_array, function (i, values) {
                            var td = $("<td class='color'>" + values + "</td>");
                            td.appendTo(tr);
                        });
                        var td1 = $("<td ><input class=\"price\" name=\"price[]\" type=\"text\" value=\"\"></td>");
                        td1.appendTo(tr);
                        var td2 = $("<td ><input class=\"num\" name=\"num[]\" type=\"text\" value=\"\"></td>");
                        td2.appendTo(tr);
